...
pub trait LexerRecog<T>: Recognizer + Actions<Recog=T> + Sized + 'static {
    /// Callback to extend emit behavior
    fn before_emit(_lexer: &mut T) {}
}

pub struct BaseLexer<T: LexerRecog<Self> + 'static> {
...
impl<T: LexerRecog<Self> + 'static> Deref for BaseLexer<T> {
    type Target = T;
...
impl<T: LexerRecog<Self> + 'static> DerefMut for BaseLexer<T> {
...
impl<T: LexerRecog<Self> + 'static> BaseLexer<T> {
...
impl<T: LexerRecog<Self> + 'static> TokenSource for BaseLexer<T> {
    #[allow(unused_labels)]
...
fn notify_listeners<T: LexerRecog<BaseLexer<T>> + 'static>(_liseners: &mut Vec<Box<dyn ErrorListener>>, e: &ANTLRError, lexer: &BaseLexer<T>) {
...
impl<T: LexerRecog<Self> + 'static> Lexer for BaseLexer<T> {
    fn set_channel(&mut self, v: isize) {
        self.channel = v;
    }
